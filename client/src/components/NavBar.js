...
export const NavBar = () => {
  ...
  const renderMenu = (
    <Menu
      ...
      open={isMenuOpen}
      onClose={profileAccess}
    >
      <MenuItem onClick={profileAccess}>My account</MenuItem>
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <div className={classes.sectionDesktop}>
            <IconButton color="inherit" onClick={handleListingsClick}>
              <Badge color="secondary">
                <ListAltIcon />
              </Badge>
            </IconButton>

            <IconButton color="inherit" onClick={handleAddListingClick}>
              <Badge color="secondary">
                <AddIcon />
              </Badge>
            </IconButton>
            ...
            {user ? (
              ...
              <>
                <Button className={classes.textColor} onClick={profileAccess}>
                  Log In
                </Button>
              </>
            )}
